...
//             await (<any>message.guild.members.cache.get(user.id)).addRole(teamRole);
//         });

//         // ===================
//         // Create the category
//         let teamCategory = await message.guild.channels.create(args.teamName, {
//             type: "category"
//         });
...
//         let teamTextChannel = await message.guild.channels.create(args.teamName, {
//             type: "text"
//         });

//         await teamTextChannel.overwritePermissions(message.guild.role defaultRole, {
//             VIEW_CHANNEL: false
//         });
